...
export async function GET(_: Request, { params }: Params) {
  ...
  const [items, images, links, reflections, parentComments] = await Promise.all([
    supabaseAdmin
      ...
      .select('id, rubric_title_snapshot, rubric_goal_snapshot, rubric_task_snapshot, rubric_level_high_snapshot, rubric_level_mid_snapshot, rubric_level_low_snapshot, grade, teacher_feedback, sort_order')
